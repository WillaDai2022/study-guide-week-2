...
def without_duplicates(words):
    ...
    return list(a_set)  ## return list(set(words))
...
def find_unique_common_items(items1, items2):
    ...
    **IMPORTANT**: you may not use `'if ___ in ___``
    ...
    return res_set       ### return set(items1) & set(items2)
...
def top_chars(phrase):
    ...
    for char in phrase:
        ...
        if dic[char] > most_common_count:
            most_common_count = dic[char]
